...
characters.all.clean %<>%
  str_replace(pattern = rebus::or("the ", "The ") %R% optional(rebus::or("giant ", "second ")), replacement = "") %>%
  str_replace(pattern =" and various White Walkers", replacement = ""   )
...
characters.all.clean %<>% c("Adrack Humble", "Akho", "Axell Florent", 
                      ...
                      "Jafer Flowers", "Joyeuse Erenford", "Kegs") #in
...
characters.dead %<>% filter(!character %in% c("A white walker" , "Bannen", "Baratheon general",
                                              "Billy", "Despondent man", "Dornish guards", #out
                                              "Drennan", "Frey soldiers", "Great master", "Jack",
                                              "Karstark lookout"))

characters.dead %<>%
  mutate(character = character %>% 
           str_replace_all(pattern = rebus::or("Brother ", " and the villagers"), 
                           replacement = "") %>%
