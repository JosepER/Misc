...
pattern.character.names <- rebus::or("[[:upper:]]+ [[:upper:]]+:", # upper two words
                                     "[[:upper:]]+:", # upper single word
                                     "[[:upper:]][[:lower:]]+ [[:upper:]][[:lower:]]+:", # lower two words
                                     "[[:upper:]][[:lower:]]+:" # lower single word
                                     )
