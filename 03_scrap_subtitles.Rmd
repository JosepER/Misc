...
# Clean names in transcritpts and match them to character names in previous scripts
...
error.sources.pattern. <- rebus::or("ALLISER", "LADY CRANE", "ARCHMAESTER",
                                    "LORD OF BONES")
...
Note: make sure all deleted characters are actually in the list. the original list of deleted characters was not trimmed.

Maybe trimm delete.non.characters first?
```{r eval=TRUE, warning=FALSE, message=FALSE}
